...
export const subjects = [
  "Biology or Agric Science or Health Science or Food and Nutrition or Catering Craft or Home Management or Animal Husbandary or Data Processing and Tourism",
...
export const Tuition = [
  {
    ...
    studentPracticalsPrice1: "#90,500",
    studentPracticalsPrice2: "#90,500",
    ...
    totalFeesPrice1: "#367,800",
    totalFeesPrice2: "#320,800",
  },

  {
    ...
    totalFees: "TOTAL FEES TO BE PAID",
    totalFeesPrice1: "#367,600",
    totalFeesPrice2: "#319,800",
  },
